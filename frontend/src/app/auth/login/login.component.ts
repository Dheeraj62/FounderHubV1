...
@Component({
  ...
  template: `
    <div class="min-h-[100dvh] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-black">
      ...
      <!-- Centered Container -->
      <div class="relative z-10 w-full max-w-[420px] mx-auto px-1">
        ...
        <div class="text-center mb-6 sm:mb-8">
          ...
          <p class="mt-2 sm:mt-3 text-indigo-100/80 text-xs sm:text-sm font-medium tracking-wide">Connect founders with investors. No noise.</p>
        </div>
        ...
        <div class="bg-white/95 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/40 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 transition-all">
          <h2 class="text-xl sm:text-2xl font-extrabold text-neutral-900 mb-5 sm:mb-6 text-center tracking-tight">Welcome back</h2>
